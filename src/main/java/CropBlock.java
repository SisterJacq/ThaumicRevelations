...
public class CropBlock extends BlockBush implements IGrowable {
	...
	public void onBlockClicked (World world, int x, int y, int z, EntityPlayer player) {
		if (!world.isRemote) {
			...
			if (meta == 8) {
				...
				EntityItem entityitem = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, ThaumRevLibrary.potato/*new ItemStack(NContent.plantItem, 1, 3)*/);
	...
	{
		return ThaumRevLibrary.potato.getItem();//NContent.plantItem;
	}

	public Item getSeedItem (int meta)
	{
		return ThaumRevLibrary.potato.getItem();//NContent.seeds;
	}
