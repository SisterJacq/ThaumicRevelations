package mortvana.melteddashboard;
...
public final class ColorLibrary {
	...
	//Na
	//Mg
	public static final int CMAT_ALUMINIUM = 0xD6D6D9;
	//Si
	//P
	//S
	//K
	//Ca
	//Sc
	public static final int CMAT_TITANIUM = 0x82808F;
	//V
	public static final int CMAT_CHROMIUM = 0xDBCBCC;
	public static final int CMAT_MANGANESE = 0xA88F91;
	//Fe
	public static final int CMAT_COBALT = 0x5E7984;
	public static final int CMAT_NICKEL = 0xCEC59A;
	public static final int CMAT_COPPER = 0xC95926;
	public static final int CMAT_ZINC = 0xE2E2C3;
	//Ga
	//Ge
	public static final int CMAT_ARSENIC = 0x968866;
	//Se
	//Rb
	//Sr
	//Y
	//Zr
	//Nb
	public static final int CMAT_MOLYBDENUM = 0x808080;
	//Tc
	//Ru
	//Rh
	public static final int COLOR_MATERIAL_PALLADIUM = 0xA1C6CA;
	...
	//Hf
	//Ta
	public static final int COLOR_MATERIAL_TUNGSTEN = 0x373737;
	//Re
	public static final int COLOR_MATERIAL_OSMIUM = 0x6C7B89;
	public static final int COLOR_MATERIAL_IRIDIUM = 0xF1F1F1;
	...
	public static final int COLOR_MATERIAL_BISMUTH = 0x80AFAF;
	//Po
	//At
	//Fr
	//Ra
	...
	public static final int COLOR_MATERIAL_BRASS = 0xB2943D;
	public static final int COLOR_MATERIAL_STEEL = 0x666363;

	public static final int COLOR_MATERIAL_BISMUTH_BRONZE = 0x639995;
	public static final int COLOR_MATERIAL_WSTEEL = 0x3C3A3F;
	public static final int COLOR_MATERIAL_STAINLESS = 0xA3B5AF;
	public static final int COLOR_MATERIAL_CUPRONICKEL = 0x926536;
	public static final int COLOR_MATERIAL_MITHRIL = 0x989D6B;
