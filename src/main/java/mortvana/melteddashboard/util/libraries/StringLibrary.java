...
public class StringLibrary {
	...
	public static final String AS = "Arsenic";
	public static final String PD = "Palladium";
	public static final String AG = "Silver";
	public static final String SN = "Tin";
	public static final String SB = "Antimony";
	public static final String ND = "Neodymium";
	public static final String LU = "Lutetium";
	public static final String W = "Tungsten";
	public static final String OS = "Osmium";
	public static final String IR = "Iridium";
	public static final String PT = "Platinum";
	...
	public static final String TSTL = "ThaumicSteel";
	public static final String VBRS = "Voidbrass";
	public static final String VSTL = "Voidsteel";
	...
	public static final String WCMP = "WardenicComposite";
	public static final String ARDS = "ArcaneRedsolder";
	public static final String RDBR = "Redbronze";
	public static final String HRBR = "HardenedRedbronze";
	public static final String FSTL = "Fluxsteel";
	public static final String FLXW = "FluxedTungsten";
	public static final String MCMP = "MagneoturgicComposite";
	public static final String FCMP = "FluxedComposite";
	public static final String RCMP = "ResonantFluxedComposite";
	public static final String EVBS = "EmpoweredVoidbrass";
