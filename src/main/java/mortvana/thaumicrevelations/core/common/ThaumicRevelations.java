...
public class ThaumicRevelations {
    ...
    @SidedProxy(clientSide = "mortvana.thaumicrevelations.core.network.ClientProxy", serverSide = "mortvana.thaumicrevelations.core.network.CommonProxy", modId = ThaumRevLibrary.MOD_ID)
