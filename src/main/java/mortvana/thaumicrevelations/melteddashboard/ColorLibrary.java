package mortvana.thaumicrevelations.melteddashboard;
...
public final class ColorLibrary {
	...
	//Na
	//Mg
	public static final int COLOR_MATERIAL_ALUMINIUM = 0xD6D6D9;
	//Si
	//P
	//S
	//K
	//Ca
	//Sc
	public static final int COLOR_MATERIAL_TITANIUM = 0x82808F;
	//V
	public static final int COLOR_MATERIAL_CHROMIUM = 0xDBCBCC;
	public static final int COLOR_MATERIAL_MANGANESE = 0xA88F91;
	//Fe
	public static final int COLOR_MATERIAL_COBALT = 0x5E7984;
	public static final int COLOR_MATERIAL_NICKEL = 0xCEC59A;
	public static final int COLOR_MATERIAL_COPPER = 0xC95926;
	public static final int COLOR_MATERIAL_ZINC = 0xE2E2C3;
	//Ga
	//Ge
