...
import mortvana.thaumicrevelations.core.common.ThaumRevContent;
import mortvana.thaumicrevelations.melteddashboard.intermod.thaumcraft.research.FluxGearResearchItem;
import mortvana.thaumicrevelations.melteddashboard.util.helpers.ItemHelper;
...
public class WardenContent implements IConfigInitialized {
	...
	public void loadArmor() {
		wardenclothSkullcap = (ItemArmorInfusableBase) new ItemArmorWardencloth(0, "wardencloth.skullcap", "wardenclothSkullcap").register("skullcap", "WardenclothSkullcap");
		wardenclothTunic = (ItemArmorInfusableBase) new ItemArmorWardencloth(1, "wardencloth.tunic", "wardenclothTunic").register("tunic", "WardenclothTunic");
		wardenclothPants = (ItemArmorInfusableBase) new ItemArmorWardencloth(2, "wardencloth.pants", "wardenclothPants").register("pants", "WardenclothPants");
		wardenclothBoots = (ItemArmorInfusableBase) new ItemArmorWardencloth(3, "wardencloth.boots", "wardenclothBoots").register("boots", "WardenclothBoots");
	}
	...
	public void loadThaumicRecipes() {
		...
		recipeWardenclothSkullcap = ThaumcraftApi.addArcaneCraftingRecipe(keyArmorWardencloth, wardenclothSkullcap.stack, ThaumcraftHelper.newPrimalAspectList(10), "WEW", "EGE", 'E', "itemEnchantedFabric", 'W', "itemWardencloth", 'G', ThaumRevContent.itemGoggles);
