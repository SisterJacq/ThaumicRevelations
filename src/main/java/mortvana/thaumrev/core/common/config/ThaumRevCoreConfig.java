...
public class ThaumRevCoreConfig extends ConfigBase {

    public static Configuration config;

    public ThaumRevCoreConfig(FMLPreInitializationEvent event, String location) {
    ...
    public void loadConfig(File file) {
	    ...
	    researchLevel = (byte) config.get("Miscellaneous", "Research Difficulty", -1, "Independent from Thaumcraft's Research Difficulty. Determines which researches auto-unlock. -1 for using Thaumcraft's difficulty, 0 for easy, 1 for normal (default Thaumcraft setting), 2 for hard.").getInt();
