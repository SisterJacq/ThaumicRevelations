...
public class ModResearch {
    ...
    public static void initResearch() {
        ...
        researchTWarden = new ModResearchItem(ResearchLib.TREVELATIONS_KEY, ResearchLib.CATEGORY_KEY, new AspectList(), 0, 0, 0, new ItemStack(ModContent.itemWardenAmulet)).setRound().setSpecial().setAutoUnlock().registerResearchItem();
        researchTWarden.setPages(new ResearchPage("0"));
        researchExubitura = new ModResearchItem(ResearchLib.EXUBITURA_KEY, ResearchLib.CATEGORY_KEY, new AspectList(), 0, -2, 0, new ItemStack(ModContent.blockExubitura)).setParents(ResearchLib.TREVELATIONS_KEY).setAutoUnlock().registerResearchItem();
        researchExubitura.setPages(new ResearchPage("0"));
        researchQuartz = new ModResearchItem(ResearchLib.QUARTZ_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.CRYSTAL, 4), 2, 0, 2, new ItemStack(ModContent.itemResource, 0, 2)).setParents(ResearchLib.TREVELATIONS_KEY).setRound().registerResearchItem();
        researchQuartz.setPages(new ResearchPage("0"), new ResearchPage(ModRecipes.recipeQuartz));
        researchCrystal = new ModResearchItem(ResearchLib.CRYSTAL_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.CRYSTAL, 4), -2, 0, 2, new ItemStack(ModContent.itemResource, 0, 1)).setParents(ResearchLib.TREVELATIONS_KEY).setSecondary().registerResearchItem();
        researchCrystal.setPages(new ResearchPage("0"), new ResearchPage(ModRecipes.recipeCrystal));
        researchWardenArmor = new ModResearchItem(ResearchLib.WARDEN_ARMOR_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.CRYSTAL, 4).add(Aspect.ARMOR, 4), 6, 2, 3, new ItemStack(ModContent.itemWardenChest)).setParents(ResearchLib.WASLIE_HAMMER_KEY).setRound().setSpecial().registerResearchItem();
        ...
        researchWardenWeapon = new ModResearchItem(ResearchLib.WARDEN_WEAPON_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.CRYSTAL, 4).add(Aspect.WEAPON, 4), 6, 6, 3, new ItemStack(ModContent.itemWardenSword)).setParents(ResearchLib.WASLIE_HAMMER_KEY).setRound().setSpecial().registerResearchItem();
        researchWardenWeapon.setPages(new ResearchPage("0"), new ResearchPage(ModRecipes.recipeWardenSword));
        researchWaslieHammer = new ModResearchItem(ResearchLib.WASLIE_HAMMER_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.CRYSTAL, 4), 4, 4, 3, new ItemStack(ModContent.itemWaslieHammer)).setParentsHidden(ResearchLib.CRYSTAL_KEY, ResearchLib.QUARTZ_KEY).setParents(ResearchLib.LORE4_KEY).setRound().setSpecial().registerResearchItem();
        researchWaslieHammer.setPages(new ResearchPage("0"), new ResearchPage(ModRecipes.recipeWaslieHammer));

        researchIllumination = new ModResearchItem(ResearchLib.FOCUS_ILLUMINATION_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(Aspect.AIR, 2).add(Aspect.FIRE, 2), 0, 4, 1, new ItemStack(ModContent.itemFocusIllumination)).setRound().setParentsHidden("FOCUSFIRE").registerResearchItem();
        researchIllumination.setPages(new ResearchPage("0"), new ResearchPage(ModRecipes.recipeFocusIllumination));

        researchLore1 = new ModResearchItem(ResearchLib.LORE1_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.MIND, 4), 0, 2, 3, new ItemStack(ModContent.itemWardenAmulet)).setParents(ResearchLib.TREVELATIONS_KEY).setRound().setSpecial().registerResearchItem();
        researchLore1.setPages(new ResearchPage("0"), new ResearchPage("1"), new ResearchPage("2"));
        researchLore2 = new ModResearchItem(ResearchLib.LORE2_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.MIND, 4), -2, 4, 3, new ItemStack(ModContent.itemWardenAmulet)).setParents(ResearchLib.LORE1_KEY).setRound().setSpecial().registerResearchItem();
        researchLore2.setPages(new ResearchPage("0"), new ResearchPage("1"), new ResearchPage("2"), new ResearchPage("3"));
        researchLore3 = new ModResearchItem(ResearchLib.LORE3_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.MIND, 4), 0, 6, 3, new ItemStack(ModContent.itemWardenAmulet)).setParents(ResearchLib.LORE2_KEY).setRound().setSpecial().registerResearchItem();
        ...
        researchLore4 = new ModResearchItem(ResearchLib.LORE4_KEY, ResearchLib.CATEGORY_KEY, new AspectList().add(EXUBITOR, 4).add(Aspect.MIND, 4), 2, 4, 3, new ItemStack(ModContent.itemWardenAmulet)).setParents(ResearchLib.LORE3_KEY).setRound().setSpecial().registerResearchItem();
